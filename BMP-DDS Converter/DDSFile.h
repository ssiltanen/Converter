...
typedef enum DXGI_FORMAT {		/**** Enum used in DDS_HEADER_DXT10 ****/
...
typedef enum D3D10_RESOURCE_DIMENSION {		/**** Enum used in DDS_HEADER_DXT10 ****/
...
typedef struct {							/**** DDS DXT10 Header ****/
	...
	unsigned int miscFlag;							//Identifies other, less common options for resources
	unsigned int arraySize;							//The number of elements in the array
	unsigned int miscFlags2;						//Contains additional metadata
} DDS_HEADER_DXT10;

#define DDS_dwMagic 0x20534444 //DDS
#define DDPF_FOURCC 0x4 //Uses DXT10 header
#define DXT1 0x31545844 //DXT1 value for dwfourCC
